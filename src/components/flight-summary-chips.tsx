...
type FlightSummaryVariant = 'hero' | 'default'
      ...
      <div className="relative">
        ...
        <div className="rounded-2xl bg-gradient-to-r from-[#E8F4F4] via-[#FDF1EE] to-[#E8F4F4] p-[1px] shadow-[0_6px_18px_rgba(0,46,52,0.08)]">
          <div className="rounded-2xl bg-white p-4 md:p-6">
            <div className="flex flex-wrap items-center gap-4 md:gap-5 text-sm text-[#0D2B29]">
              <span className="inline-flex items-center gap-2 px-3 py-2 rounded-full bg-[#E8F4F4]">
                <span className="px-2 py-1 rounded-full bg-[#0ABAB5] text-white text-xs font-semibold">{from || '—'}</span>
                <span className="font-semibold">{fromAirport?.city || fromAirport?.name || from}</span>
              </span>

              <span className="w-7 h-7 rounded-full bg-[#0ABAB5]/10 text-[#0ABAB5] flex items-center justify-center">
                ↔
              </span>

              <span className="inline-flex items-center gap-2 px-3 py-2 rounded-full bg-[#E8F4F4]">
                <span className="px-2 py-1 rounded-full bg-[#0ABAB5] text-white text-xs font-semibold">{to || '—'}</span>
